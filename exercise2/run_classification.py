...
class DataTrainingArguments:
    ...
    freeze_modules: Optional[str]= field(
        default=None, metadata={"help": "Freeze modules matching this regex."}
    )
...
def main():
    ...
    if data_args.freeze_modules:
        import regex
        for name, param in model.named_parameters():
            if regex.search(data_args.freeze_modules, name):
    ...
    logger.info(f"Model size: {num_params:,} params ({num_trainable:,} trainable)")
